 ...
 ***************************************************/
 ...
 #define CUT_OFF_DENSITY ( 0.00000001 * 0.0010 * 1.  )
 ...
 #define N_DELTA_T ( 260 )
 #define MEMORY_LENGTH ( 6 ) // Memory length 4 means 0,1,2,3 time steps with 0 initial state, so 3 time steps 
